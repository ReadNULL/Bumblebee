/**
 * 微信登录认证模块
 * 来源: pi-weixinbot (https://github.com/huang-x-h/pi-weixinbot)
 * 参考: https://github.com/Tencent/openclaw-weixin
 *
 * 适配: 存储路径改为 ~/.bumblebee/weixin/
 */
...
import { getQRCode, getQRCodeStatus, DEFAULT_BASE_URL } from "./weixin-api.js";
import type { QRCodeResponse, QRStatusResponse, LoginResult, WeixinAccountData } from "./types.js";
...
// ============================================================================
// 存储管理（路径已适配为 Bumblebee）
// ============================================================================

export function getStateDir(): string {
  return path.join(homedir(), ".bumblebee", "weixin");
}
